...
If the "do something" is a short, simple expression, 
however, we can move it up into a single line 
...
followed by a boolean. The order is important. 
...
It's also important to note that you don't need 
