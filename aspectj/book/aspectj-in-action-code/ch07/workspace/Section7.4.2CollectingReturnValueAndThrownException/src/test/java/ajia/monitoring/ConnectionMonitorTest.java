...
public class ConnectionMonitorTest {
	...
	public void connectionMonitoredNormal() throws SQLException {
		...
		verify(out).println("Just used testConnection successfully which returned ps");
	}
	...
	public void connectionMonitoredException() throws SQLException {
		...
		try {
			...
			verify(out).println("Just used testConnection but met with a failure of kind java.sql.SQLException");
			throw ex;
		}
	}
