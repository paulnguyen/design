...
import ajia.banking.domain.ExampleEntityThatDoesntImplementGetSetId;

public class AccountTrackingTest {
	@Test
	public void mixin() {
		ExampleEntityThatDoesntImplementGetSetId entity = new ExampleEntityThatDoesntImplementGetSetId();
