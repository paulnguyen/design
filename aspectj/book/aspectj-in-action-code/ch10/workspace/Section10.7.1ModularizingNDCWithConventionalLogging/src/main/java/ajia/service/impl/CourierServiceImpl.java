...
public class CourierServiceImpl implements CourierService {
	...
	public Tracking send(Package packageToSend) {
		logger.log(Level.INFO, "[CourierServiceImpl.send] Sending package");
		return new Tracking("1234" + packageToSend.getPackageNumber());
	}
