...
public class JpaInventoryItemRepository extends
        JpaGenericRepository<InventoryItem> implements InventoryItemRepository {
    public InventoryItem findByProduct(Product product) {
        Query query = em.createQuery("select o from InventoryItem o "
