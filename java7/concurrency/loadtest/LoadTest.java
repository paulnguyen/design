...
/**
   COPYRIGHT (C) 2001 Paul Nguyen. All Rights Reserved
   Load Test Program which sends HTTP Get Requests repeatedly
   to a list of URLs.  This solves prereq quiz for MS 286.
   @author Paul Nguyen
   @version $Revision: 1.4 $ $Date: 2001/09/16 05:51:37 $

   CVS Revision Log:
   $Id: LoadTest.java,v 1.4 2001/09/16 05:51:37 pnguyen Exp $
   $Log: LoadTest.java,v $
   Revision 1.4  2001/09/16 05:51:37  pnguyen
   Moved to new dir

   Revision 1.3  2001/08/31 21:42:23  pnguyen
   Fixed Tab Problems.  Added loadThreads() helper method.

   Revision 1.2  2001/08/31 20:21:26  pnguyen
   Fixed CVS Revision Tag Name.
   
   Revision 1.1  2001/08/31 20:19:01  pnguyen
   Initial Check In.
...
public class LoadTest {
   ...
   */
   LoadTest( ThreadGroup grp, String srcURL ) 
   {
      this.myURL = srcURL ;
      this.reqCount = 0 ;
      this.myGroup = grp ;    
