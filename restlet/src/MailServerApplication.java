...
public class MailServerApplication extends Application {
    ...
    public MailServerApplication() {
        ...
        setDescription("Example from Restlet in Action book");
    ...
    public Restlet createInboundRoot() {
        ...
        MailServerTracer tracer = new MailServerTracer(getContext());

        MailServerBlocker blocker = new MailServerBlocker(getContext());
